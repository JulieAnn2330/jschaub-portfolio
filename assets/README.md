...
<h2>Professional Portfolio</h2> <a href="#license"><img src= "https://img.shields.io/badge/License-MIT-blue.svg"></a><br>
...
<p>This is a professional portfolio for potential employers to browse. As I am beginning my job search, I wanted a showcase piece that I could provide to potential employers that would give them examples of my coding abilities.    </p><br>
...
Axios,Bootstrap,CSS,HTML,JavaScript,React</p><br>
<a href="#top" id="start">(Back to Top of Page)</a><br>
<br>
<hr color= "slateblue" noshade>

<h3 id='installation'>Installation</h3>
<p>If you are viewing from the terminal, run npm start, otherwise the deployed link is all that is needed.</p><br>
<a href="#top" id="start">(Back to Top of Page)</a><br>
<br>
<hr color= "slateblue" noshade>
